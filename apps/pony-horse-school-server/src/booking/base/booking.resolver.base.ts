...
import { Horse } from "../../horse/base/Horse";
...
export class BookingResolverBase {
  ...
  async createBooking(
    ...
    return await this.service.createBooking({
      ...
      data: {
        ...
        horse: args.data.horse
          ? {
              connect: args.data.horse,
            }
          : undefined,
      },
    });
  ...
  async getHorse(@graphql.Parent() parent: Booking): Promise<Horse | null> {
    const result = await this.service.getHorse(parent.id);
  ...
  @graphql.Mutation(() => UpdateBookingStatusInput)
  async ApproveBooking(
    @graphql.Args()
    args: UpdateBookingStatusInput
  ): Promise<UpdateBookingStatusInput> {
    return this.service.ApproveBooking(args);
  }

  @graphql.Mutation(() => CreateBookingInput)
  async CreateBooking(
    @graphql.Args()
  ...
  async DeclineBooking(
    ...
    return this.service.DeclineBooking(args);
  }
}
